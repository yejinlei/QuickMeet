    ...
    match *req.method() {
        Method::GET => {
            ...
            let body = serde_json::json!({
                ...
                "heartbeat_sent_count": s.heartbeat_sent_count,
                "heartbeat_dropped": s.heartbeat_dropped,
                ...
                "dead_nodes_detected": s.dead_nodes_detected,
                "pruned_dead_nodes": s.pruned_dead_nodes,
                "rooms_created": s.rooms_created,
                "rooms_placed": s.rooms_placed,
                "rooms_released": s.rooms_released,
                "migrations_attempted": s.migrations_attempted,
                "migrations_completed": s.migrations_completed,
                "migrations_failed": s.migrations_failed,
                "failover_retries": s.failover_retries,
                "rejoin_count": s.rejoin_count,
                "reconnect_attempts": s.reconnect_attempts,
                "last_reconnect_ms": s.last_reconnect_ms,
                "last_disconnect_ms": s.last_disconnect_ms,
                "nats_connects": s.nats_connects,
                "view_converge_ms": s.view_converge_ms,
                "last_health_check_ms": s.last_health_check_ms,
